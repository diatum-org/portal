...
public class Stat extends PortalStat implements Serializable {
  private Integer id;
  ...
  public void setDevices(Long value) {
    super.setDevices(value);
  }
  ...
  public void setCerts(Long value) {
    super.setCerts(value);
  }
}
